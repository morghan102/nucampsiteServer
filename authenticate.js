...
exports.facebookPassport = passport.use(
    new FacebookTokenStrategy( //this is from the fb token strategy constructor
        {//settings
            clientID: config.facebook.clientId, //appID, both taken from the config module
            clientSecret: config.facebook.clientSecret //appSecret
        }, 
        (accessToken, refreshToken, profile, done) => { //verify callback func
